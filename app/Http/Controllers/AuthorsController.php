...
class AuthorsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("flash_notification", ["lavel"=>"success","message"=>"Berhasil menyimpan $author->name"]);
        return redirect()->route('authors.index');
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash("flash_notification", ["level"=>"seccess","message"=>"Penulis berhasil dihapus"]);
        return redirect()->route('authors.index');
    }
}
